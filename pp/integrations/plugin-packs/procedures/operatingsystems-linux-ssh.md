...
| Metric name       | Unit  |
|:------------------|:------|
| quota#data-usage  | N/A   |
| quota#inode-usage | N/A   |
...
| WARNINGMETAUSAGE  | Warning threshold                                                                                   |                   |             |
| CRITICALMETAUSAGE | Critical threshold                                                                                  |                   |             |
...
| directlvm-usage [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/os/linux/local/mode/directlvmusage.pm)]           | OS-Linux-Directlvm-Usage-SSH-custom   |
...
| Option       | Description                                                       |
|:-------------|:------------------------------------------------------------------|
| --warning-*  | Warning threshold. Can be: 'data-usage' (%), 'meta-usage' (%).    |
| --critical-* | Critical threshold. Can be: 'data-usage' (%), 'meta-usage' (%).   |
| --filter-vg  | Filter virtual group (regexp can be used).                        |
