...
|:--------------|:----------------------------------|:--------------------|
| Cpu           | Net-Aruba-Cppm-Cpu-SNMP-custom    | Check cpu           |
| Disks         | Net-Aruba-Cppm-Disks-SNMP-custom  | Check disks         |
| Memory        | Net-Aruba-Cppm-Memory-SNMP-custom | Check memories      |
...
|:--------------|:----------------------------------------|:-------------------------------------------|:----------:|
| Interfaces    | Net-Aruba-Cppm-Interfaces-SNMP-custom   | Check interfaces                           | X          |
| Radius        | Net-Aruba-Cppm-Radius-SNMP-custom       | Check radius statistics                    |            |
| Repositories  | Net-Aruba-Cppm-Repositories-SNMP-custom | Check authentication repository statistics |            |
| Tacacs        | Net-Aruba-Cppm-Tacacs-SNMP-custom       | Check TACACS                               |            |
...
|:----------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SNMP Agents     | Discover your resource devices through a SNMP subnet scan. You need to install the [Generic SNMP](./applications-protocol-snmp.md) to get the discovery rule and create a template mapper for the **Net-Aruba-Cppm-SNMP** host template |
