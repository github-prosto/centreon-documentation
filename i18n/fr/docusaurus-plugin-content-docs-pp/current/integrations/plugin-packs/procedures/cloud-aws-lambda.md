...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Cloud-Aws-Lambda-custom** est utilisé.
...
| lambda.function.iteratorage.milliseconds | ms    |
...
| FUNCTIONNAME  | Set the function name (Required) (can be defined multipletimes)                                                                   | .*                | X           |
...
```bash
OK: Duration: 69 ms Invocations: 19 Errors: 36 Dead Letter Errors: 76 Throttles: 34 Iterator Age: 12 ms | 'lambda.function.duration.milliseconds'=69ms;;;; 'lambda.function.invocations.count'=19;;;; 'lambda.function.errors.count'=36;;;; 'lambda.function.deadlettererrors.count'=76;;;; 'lambda.function.throttles.count'=34;;;; 'lambda.function.iteratorage.milliseconds'=12ms;;;; 
```
...
|:-------------------------------------------------------------------------------------------------------------------------|:----------------------------------------|
| discovery [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/aws/lambda/mode/discovery.pm)]     | Used for host discovery                 |
| invocations [[code](https://github.com/centreon/centreon-plugins/blob/develop/src/cloud/aws/lambda/mode/invocations.pm)] | Cloud-Aws-Lambda-Invocations-Api-custom |
...
| --name                                     | Set the function name (Required) (can be defined multipletimes).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --filter-metric                            | Filter metrics (Can be: 'Duration', 'Invocations', 'Errors', 'DeadLetterErrors', 'Throttles', 'IteratorAge') (Can be a regexp).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| --warning-*                                | Thresholds warning (Can be: 'invocations', 'errors', 'throttles', 'duration', 'deadlettererrors', 'iteratorage').                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --critical-*                               | Thresholds critical (Can be: 'invocations', 'errors', 'throttles', 'duration', 'deadlettererrors', 'iteratorage').                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
